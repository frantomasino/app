...
export function DeleteRemitoButton({
  remitoId,
  remitoNumber,
  status,
}: DeleteRemitoButtonProps) {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Estás por eliminar la <strong>Venta #{remitoNumber}</strong>.{" "}
            {status === "confirmed"
              ? "Esta acción no se puede deshacer y devolverá el stock de los productos asociados."
